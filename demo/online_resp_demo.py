...
recognizer = Recognizer(output_dir='logs',
                        model_cfg='tasks/SpeechRecognition/krespspeech/configs/jasper10x5dr_sp_offline_specaugment.yaml',
                        ckpt='tasks/SpeechRecognition/krespspeech/checkpoints/Jasper_epoch80_checkpoint.pt',
                        task_path="tasks.SpeechRecognition.krespspeech.local.manifest",
                        vocab="tasks/SpeechRecognition/krespspeech/data/KrespSpeech/vocab")
...
async def main(request: Request):
    return templates.TemplateResponse("index_resp.html", {"request": request})
...
if __name__ == "__main__":
    uvicorn.run("online_resp_demo:app", host="0.0.0.0", port=15003, log_level="info",
